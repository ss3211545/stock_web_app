...
class TailMarketStockApp:
    ...
    def _find_partial_matches(self):
        """查找部分匹配的股票"""
        if hasattr(self.data_fetcher, 'partial_results'):
            ...
            # 获取涨幅前20名股票
            top_stocks = self.data_fetcher.get_top_increase_stocks(self.data_fetcher.get_stock_list(self.selected_market.get()), limit=20)
